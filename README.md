...
![Image of FSID](https://raw.githubusercontent.com/acexxy/RDP-Google-Debian/acexxy/show.png)
...
* Paste Code
  ...
  * Paste this code ctrl+v
    ...
    ```shell
    ! wget https://raw.githubusercontent.com/fsteamID/RDP-Google-Debian/acexxy/RDP.sh
    ! chmod +x RDP.sh
    ! ./RDP.sh
    ```
